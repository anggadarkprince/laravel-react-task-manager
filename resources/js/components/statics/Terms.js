...
export default Terms => (
    <div>
        ...
        <p>Please read these Terms and Conditions ("Terms", "Terms and Conditions") carefully before using the
            Task Manager website (the "Service") operated by Task Manager ("us", "we", or "our").</p>
        ...
        <p>By accessing or using the Service you agree to be bound by these Terms. If you disagree with any part of the
            ...
            <a href="https://termsfeed.com" rel="nofollow">TermsFeed</a> for Task Manager.</p>
        ...
        <p>Task Manager has no control over, and assumes no responsibility for, the content,
            privacy policies, or practices of
            any third party web sites or services. You further acknowledge and agree that
            Task Manager shall not be responsible or
        ...
        <p>Our failure to enforce any right or provision of these Terms will not be considered a waiver of those rights.
            ...
            these
            Terms will remain in effect. These Terms constitute the entire agreement between us regarding our Service,
            and
